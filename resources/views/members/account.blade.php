    ...
    <div class="container pb-5 mb-2 mb-md-3">
        <div class="row">
            ...
            <section class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="account-fn" name="name" value="{{ $userDetails->name }}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="account-phone">Phone Number</label>
                                <input class="form-control" type="text" id="account-phone" value="{{ $userDetails->phone }}" name="phone">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="account-phone-opt">Phone Number (Optional)</label>
                                <input class="form-control" type="text" id="account-phone-opt" value="{{ $userDetails->phone_opt }}" name="phone_opt">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="account-address">Address</label>
                                <input class="form-control" type="text" id="account-address" value="{{ $userDetails->address }}" name="address">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="account-address-opt">Address (Optional)</label>
                                <input class="form-control" type="text" id="account-address-opt"  value="{{ $userDetails->address_opt }}" name="address_opt">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="account-pincode">Pincode</label>
                                <input class="form-control" type="text" id="account-pincode" value="{{ $userDetails->pincode }}" name="pincode">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="account-state" value="{{ $userDetails->state }}" name="state">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="account-city">State</label>
                                <input class="form-control" type="text" id="account-city" value="{{ $userDetails->city }}" name="city">
                            </div>
                        </div>
                        <div class="col-12">
                            <hr class="mt-2 mb-3">
                ...
                <form action="{{ url('/update-user-password') }}" method="POST" name="passwordForm" id="passwordName" class="mt-5">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="account-fn">Current Password</label>
                                <input class="form-control" type="password" id="current_password" name="current_password" onkeyup="laravelCMS.checkPassword()">
                                <small class="form-text text-danger d-none" id="checkPasswordError"></small>
                                <small class="form-text text-success d-none" id="checkPasswordSuccess"></small>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
