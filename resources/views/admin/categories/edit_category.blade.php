        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    @endif
                    <form class="form-horizontal" enctype="multipart/form-data" action="{{ url('/admin/edit-category/'.$categoryDetails->id) }}" method="post" name="edit_category" id="edit_category">
                        {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="status" class="custom-control-input" id="status" @if($categoryDetails->status == 1) checked @endif value="1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" value="{{ $categoryDetails->name }}" class="form-control" id="name" placeholder="Category Name">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="url" value="{{ $categoryDetails->url }}" class="form-control" id="url" placeholder="URL Code">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="sort" class="col-sm-3 text-right control-label col-form-label">Sort</label>
                                <div class="col-sm-9">
                                    <input type="number" min="0" name="sort" class="form-control" value="{{ $categoryDetails->sort }}" id="sort" placeholder="Sort">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="description" class="col-sm-3 text-right control-label col-form-label">Category Description</label>
                                <div class="col-sm-9">
                                    <textarea name="description" class="form-control" id="description" placeholder="Category Description">{{ $categoryDetails->description }}</textarea>
                                </div>
                            </div>
                            ...
                            @if(!empty($categoryDetail->image))
                                <div class="form-row details-image">
                                    <div class="col-md-3">
                                        <img src="{{ asset('/backend/images/categories/small/'.$categoryDetails->image) }}" alt="{{ $categoryDetails->name }}">
                                    </div>
                                </div>
                            @endif
                        </div>
